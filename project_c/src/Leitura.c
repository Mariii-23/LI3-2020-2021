...
ReviewCollection collect_reviews(FILE *fp) {
  ...
  while ((line = read_line(fp))) {
    ...
    g_hash_table_insert(by_id, get_review_id(review), review);
    g_hash_table_insert(by_user, get_review_user_id(review), review);
    g_hash_table_insert(by_business_id, get_review_business_id(review), review);
...
BusinessCollection collect_businesses(FILE *fp) {
  ...
  while ((line = read_line(fp))) {
    ...
    g_hash_table_insert(by_city, get_business_city(business), business);
