...
void repl() {
    ...
    define_function(state, "projection", cmd_projection, VAR_TABLE, 2, "Project a table", VAR_TABLE, VAR_ARRAY);
    define_function(state, "filter", cmd_filter, VAR_TABLE, 4, "Filter a table", VAR_TABLE, VAR_STRING, VAR_STRING, VAR_OPERATOR);
