...
public class GestReviews implements Serializable {
    ...
    public String getReviewsInputFileName() {
        return catalogoReviews.getInputFileName();
    }

    public String getBusinessesInputFileName() {
        return catalogoBusinesses.getInputFileName();
    }

    public String getUsersInputFileName() {
        return catalogoUsers.getInputFileName();
    }
