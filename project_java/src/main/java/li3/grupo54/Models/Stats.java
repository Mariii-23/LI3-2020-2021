...
public class Stats implements IStats, Serializable {
    ...
    /**
     * Devolve o número de todos os users que não foram avaliados.
     *
     * @return Número de users sem reviews.
     */
     ...
     * Query 8
     *
     * @return Devolve uma Lista  de X pares, contendo um mês, o número total de reviews feitas nesse mês, a sua média,
     * o número de business distintos e o seu número de users distintos.
     */
        ...
        for (int i = 0; i < 12; i++) {
            ...
            if (tuple == null) {
                ...
                r.add(i, new MyFive<Month, Integer, Float, Integer, Integer>(Month.of(i + 1), tuple.getNumberTotal(), (float) tuple.getCurrentAverage(),
                        tuple.getBusinessDistincts(), tuple.getUserDistincts()));
            }
        }
        return r;
    }
    ...
    /**
     * Devolve o número de business que contêm reviews
     *
     * @return Número de business com reviews
     */
